const data= [
    {
        ...
        name : 'Puma Printed T-Shirt',
        price : 70,
        save : 25,
        delievery : 'In 3 - 4 days',
        spec: 'Red coloured machine printed with 6 months guarantee',
        itemInCart: false
    },
    {
        id : 1,
        img : 'images/buy-2.jpg',
        name : 'HRX Shoes',
        price : 60,
        save : 50,
        delievery : 'In 2 - 3 days',
        itemInCart: false
    },
    {
        id : 2,
        img : 'images/buy-3.jpg',
        name : 'Grey Joggers',
        price : 50,
        save : 30,
        delievery : 'In 3 - 4 days',
...
var detailspec = document.getElementById('spec')
...
function handleDetail(e){
    ...
    detailspec.innerHTML=   data[getId].spec;
